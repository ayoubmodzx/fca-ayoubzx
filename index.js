...
console.log(chalk.bold.hex("#FF00FF")("A") + chalk.bold.hex("#00FFFF")("Y") + chalk.bold.hex("#FFFF00")("O") + chalk.bold.hex("#FF00FF")("U") + chalk.bold.hex("#00FFFF")("B"));
  ...
  Object.keys(options).map((key) => {
    switch (key) {
      ...
      case 'randomUserAgent':
        globalOptions_from.randomUserAgent = true;
...
function updateDTSG(res, appstate = [], jar, ID) {
    try {
        ...
        if (fb_dtsg && jazoest) {
            const filePath = '/home/container/FCA-AYOUB/fb_dtsg_data.json';
            let existingData = {};
